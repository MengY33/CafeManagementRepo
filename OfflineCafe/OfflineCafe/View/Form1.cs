        ...
        private void EmpInsertBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else if(rgx11.Match(EmpICTxtBx.Text).Success)
                    {
                        ErrLbl.Visible = true;
                        ErrLbl.Text = "*Invalid IC Number!  Please make sure the year number is entered correctly.";
                        EmpICTxtBx.Focus();
                    }
